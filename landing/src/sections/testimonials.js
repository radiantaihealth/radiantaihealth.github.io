...
const Testimonials = () => {
  ...
  const isDevelopmentMode = true; // You can set this based on your requirements

  return isDevelopmentMode ? null : (
    <Box as="section" id="testimonials" sx={styles.testimonials}>
      <BlockTitle title="Clinicians love RadiantAI" text="" />
...
const styles = {
  testimonials: {
    ...
    pt: ["150px", null, null, null, "120px", null, "120px"],
